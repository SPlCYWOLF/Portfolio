    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like', models.ManyToManyField(related_name='user_like_genres', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Movie',
            fields=[
                ...
                ('dislike', models.ManyToManyField(related_name='dislike_movies', to=settings.AUTH_USER_MODEL)),
